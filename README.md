...
If you would like to name your database something other than `prime_app`, you will need to change `prime_app` to the name of your new database name in `server/modules/database.js`
